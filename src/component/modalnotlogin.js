                ...
                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start sm:flex-col">
                    ...
                    <div className="text-center -mt-10 mx-auto ">
                      ...
                      <Dialog.Title
                        as="h3"
                        className="text-2xl font-sans font-extrabold text-black mt-8 pb-4"
                      >
                        Action Denied
                      </Dialog.Title>
                      <div className="mt-2">
                        <p className=" text-center text-xl text-black font-sans">
                          To access tutors menu please login or create an
                          account first.
                        </p>
                      </div>
                    </div>
